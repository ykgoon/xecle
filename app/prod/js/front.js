...
app_front.core = {};
"undefined" === typeof app_front.core.app_state && (app_front.core.app_state = cljs.core.atom.call(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null, "message", "message", -406056002), "Hello Minimum app world!"], null)));
...
app_front.init.start_descjop_BANG_ = function() {
  return app_front.core.init_BANG_.call(null, app_front.conf.setting);
};
app_front.init.start_descjop_BANG_.call(null);
