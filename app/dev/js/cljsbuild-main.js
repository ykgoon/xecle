...
var app = {core:{}};
app.core.path = cljs.nodejs.require.call(null, "path");
app.core.Electron = cljs.nodejs.require.call(null, "electron");
app.core.BrowserWindow = app.core.Electron.BrowserWindow;
app.core.crash_reporter = app.core.Electron.crashReporter;
app.core.Os = cljs.nodejs.require.call(null, "os");
...
app.core._main = function() {
  ...
  app.core.app.on("window-all-closed", function() {
    return cljs.core.not_EQ_.call(null, cljs.nodejs.process.platform, "darwin") ? app.core.app.quit() : null;
  });
...
console.log([cljs.core.str("Start descjop application on "), cljs.core.str(app.core.Os.type()), cljs.core.str(".")].join(""));
